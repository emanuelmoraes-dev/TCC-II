...
%\frenchspacing 
\include{outrasFolhas/Capa}
\include{outrasFolhas/FolhaRosto}
%\include{outrasFolhas/FichaCatalografica}
\include{outrasFolhas/Aprovacao}
% \include{outrasFolhas/Dedicatoria}
% \include{outrasFolhas/Agradecimentos}
\include{outrasFolhas/Resumo}
\include{outrasFolhas/Abstract}
% \include{outrasFolhas/ListaIlustracoes}
\include{outrasFolhas/ListaTabelas}
\include{outrasFolhas/ListaQuadros}
\include{outrasFolhas/ListaExemplos}
\include{outrasFolhas/ListaAbreviaturasSiglas}
\include{outrasFolhas/Sumario}
\textual

%CAPITULOS
\include{capitulos/Introducao}
\include{capitulos/TrabalhosRelacionados}
\include{capitulos/FundamentacaoTeorica}
